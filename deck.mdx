...
- If the page takes more than 3 seconds to load almost 40% of visitors tend to leave that site

- Around 64% of a website’s weight is comprised of images

- Ligthouse doesn't approves large websites
...
- Load speed :stopwatch:

- Better performance :fire:

- Boost conversions :smile:

- Best SEO ranking :chart_with_upwards_trend:
